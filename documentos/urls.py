...
from .views import login_view, logout_view, dashboard_view, get_subproyectos, get_documentos, registrar_evento, dashboard_view, get_documento_detalle, get_eventos_documento, obtener_documentos
...
urlpatterns = [
    ...
    path('api/documentos/<int:subproyecto_id>/', obtener_documentos, name='api_documentos'),
